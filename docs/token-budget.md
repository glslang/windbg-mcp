...
gained tools and output schemas since and stood at 221,376 B on 2026-09-10.
...
8. **Five tools are a third of the model-visible surface**, and it is their *input* schemas rather
   ...
   **Finding 1's answer does not transfer here, and that is what settled it.** Prose came out of the
   ...
   |---|---:|---:|---:|
   | `allocator` | 10 | 16,457 | 18.9% |
   | `inspect` | 10 | 13,152 | 15.1% |
   | `session` | 10 | 12,817 | 14.7% |
   | `exec` | 8 | 11,309 | 13% |
   | `batch` | 1 | 10,021 | 11.5% |
   | `crash` | 3 | 7,427 | 8.5% |
   | `ttd` | 9 | 6,829 | 7.8% |
...
`outputSchema`, a scoped-start location and a per-segment completeness flag: the wire is 221,376 B against 225,000 (**1.7%**), the
