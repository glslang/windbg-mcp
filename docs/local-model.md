...
| | bytes | ≈tokens |
|---|---|---|
| The tool surface, paid once per conversation | 94,921 (63 tools) | ~24k |
...
- **The tool-surface profile is `--tools`** (2026-08-22). Start the listener with
  ...
  94,921 — `--tools crash` is 13 and 19,943 B, which is the difference between "roughly twice an 8k
