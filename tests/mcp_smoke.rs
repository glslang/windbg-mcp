...
/// any tool here has asked for. The payload went 236,791 -> 248,682, a difference of **11,891**:
/// the tool is 11,890 B of wire, and the remaining byte is the array's own comma. Nothing else
/// moved by a byte, checked against the per-tool golden keyed by name.
///
/// **10,035 B of that 11,890 is `outputSchema`, and the question this ceiling exists to force is
