...
- **The eval's answer key is re-read off the dumps rather than trusted** (`FOLLOWUPS.md` item 45,
  ...
  not say, an `expect` group widened to also accept something else, and a stale text pin — all
  seven verified against a deliberately rotted copy of the suite, with the real one green. It is a command rather than a CI
...
[Unreleased]: https://github.com/glslang/windbg-mcp/compare/v0.11.0...HEAD
