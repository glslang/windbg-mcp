...
mod tests {
    ...
    fn a_client_may_be_configured_with_a_surface_of_its_own() {
        ...
        assert_eq!(
            ...
            Some("13 of 57 tools (session, crash)"),
        ...
        assert_eq!(
            ...
            .as_deref(),
            Some("20 of 57 tools (session, inspect)")
        );
    }
    ...
    fn a_token_file_shuts_out_the_environments_surfaces_too() {
        ...
        assert_eq!(
            creds
                .surface_for("ci")
                .map(crate::toolset::Toolset::summary),
            Some("13 of 57 tools (session, crash)".to_string()),
    ...
    fn a_file_entry_without_a_surface_is_the_entry_it_always_was() {
        ...
        assert_eq!(
            creds.surfaces(),
            vec![("bench", "10 of 57 tools (session)".to_string())],
