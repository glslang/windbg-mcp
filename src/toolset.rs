...
//! 94,921 bytes — roughly 24k tokens (measured 2026-09-20; every figure here moves with any edit
...
//! whole surface they are shares of is 63 tools and 94,921 B, which is what the rows above sum to.
