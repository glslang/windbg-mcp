...
//! 91,437 bytes — roughly 23k tokens (measured 2026-09-17; every figure here moves with any edit
...
//! whole surface they are shares of is 61 tools and 91,437 B, which is what the rows above sum to.
